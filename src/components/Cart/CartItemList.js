    ...
    <div className="card">
        ...
        <div className="card-body table-responsive">
            <table className="table table-responsive">
                <thead>
                    <tr>
                        ...
                        <th>Subtotal</th>
                        <th>
                            <button onClick={discardCart} className="btn btn-sm btn-outline-primary text-white">
                                <span className="d-none d-sm-block">X</span>
            ...
            <div className="text-center mt-3">
                <Link to="/checkout" className="btn btn-primary text-white">Finalizar compra</Link>
            </div>
        </div>
    </div>
